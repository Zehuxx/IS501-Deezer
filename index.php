...
<body>
			...
			<table >
			  <tr>
			    <td id="info "  class="cambioFondo "><a href="#" class="cambioColor"> <p class="control">INICIO</p></a>
			  </td>
			  </tr>
              <tr>
			    <td id="info" class="cambioFondo"><a href="#" class="cambioColor"><p class="control">RECOMENDACIONES</p></a>
			  </td>
			  </tr>
            </table>
            <div class="linea"></div>
            <table>
					...
					<tr>
                    <td id="info" class="space cambioFondo">
                    <a href="#" class="cambioColor">
                    <span class="ajuste">
					<svg class="svg-icon icon3 svg-icon-love" viewBox="0 0 12 12" aria-hidden="true" height="16" width="16"><g><path d="M6.00011325,2.5 C6.00011325,2.5 5.00009438,1 3.25,1 C1.66669813,1 1.65327318e-16,2.25 0,4.5 C1.65327318e-16,7.5 6,11.5 6,11.5 C6,11.5 11.9999997,7.5 12,4.5 C12.0000002,2.25 10.3335284,1 8.75,1 C7.00013213,1 6.00011325,2.5 6.00011325,2.5 Z"></path></g></svg> </span><span class="letras letras1">Canciones favoritas</span>
                    </a>
                    <td>
					</tr>
                    ...
                    <a href="#" class="cambioColor">
                    <span class="ajuste">
					<svg class="svg-icon icon3 svg-icon-app" viewBox="0 0 12 12" aria-hidden="true" height="16" width="16"><g><path d="M0.375518305,6.90836424 C-0.126157409,6.40668852 -0.124187159,5.59134123 0.375518305,5.09163576 L5.09163576,0.375518305 C5.59331148,-0.126157409 6.40865877,-0.124187159 6.90836424,0.375518305 L11.6244817,5.09163576 C12.1261574,5.59331148 12.1241872,6.40865877 11.6244817,6.90836424 L6.90836424,11.6244817 C6.40668852,12.1261574 5.59134123,12.1241872 5.09163576,11.6244817 L0.375518305,6.90836424 L0.375518305,6.90836424 Z M8.56634425,6.00000601 L4.9734623,3.9469246 L4.9734623,8.0530754 L8.56634425,6.00000601 L8.56634425,6.00000601 Z"></path></g></svg></span><span class="letras letras5">Aplicaciones</span>
					</a>
					<td>
					</tr>

...
<body>
	...
	<div  class="col-lgj-2" id="barrra">
		...
		<ul class="nav" id="nav">
			...
			<li  id="start" onclick="reload();arreglo('start','first','mod','first3','start2','first2','start4','first4');" ><a href="#"  class="si"> <p id="first" >INICIO</p></a>

				
			</li>
			<li  ><a id="start2" href="#" class="si" onclick="reload();arreglo('start2','first2','start','first','mod','first3','start4','first4');"><p id="first2">RECOMENDACIONES</p></a>
			</li>
			<hr>
			<li onclick="reload()"  id="li3">
				<a id="mod" href="#" class="si" onclick="arreglo('mod','first3','start','first','start2','first2','start4','first4');"">
					...
					<li id="start4" onclick="reload();arreglo('start4','first4','start','first','mod','first3','start2','first2');" >
						...
						<li  id="li6" onclick="li('li6');ver('hijo2','hijo','hijo3','hijo4','hijo5')">
							<a href="#" class="si">
								<span>
                   ...
                   <p>2</p>
							...
							<li id="li7" onclick="li('li7');ver('hijo3','hijo2','hijo','hijo4','hijo5');">
								<a href="#" class="si">
									<span>
                     ...
                     <p>3</p>
								...
								<li  id="li8" onclick="li('li8');ver('hijo4','hijo2','hijo3','hijo','hijo5');">
									<a href="#"  class="si">
										<span>

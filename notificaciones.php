						...
						<tr>
							<td class="cell option">
								<ul>
									...
									<li class="item texxt" style="background-color: #f8f8f9;">
										Mis Comentario
									</li>
									<li class="item texxt" >
										Canciones Favoritas
							...
							<td class="cell center option">
								<button class="btn btn-default" type="button"><span class="label">Enlazar</span></button>
							</td>
							<td class="cell center option">
								<button class="btn btn-default" type="button"><span class="label">Enlazar</span></button>
							</td>
